...
public class SignUp extends AppCompatActivity {
    ...
    EditText edtname,edtpassword2,edtphone2;
    Button btnSignup;
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
...

                        {
                            ...
                            dialog.dismiss();
                                ...
                                Toast.makeText(SignUp.this, "Phone Number Already Registraton!!!! ", Toast.LENGTH_SHORT).show();
                            } else {
                            ...
                            User user = new User(edtname.getText().toString(),edtpassword2 .getText().toString());
                             table_user.child(edtphone2.getText().toString()).setValue(user);
                                Toast.makeText(SignUp.this, "Sign up Suceessfully !!!! ", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        }
